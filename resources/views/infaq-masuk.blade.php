      ...
      <div class="card card-info card-outline">
        <div class="card-header">
          <div class="card-tools">
              <a href=" {{route('infaqmasuk.create')}}" class="btn btn-success">Tambah Data</a>
              <btn class="table table-bordered">   
          </div>
        </div>
        ...
        <table class="table table-bordered">          
            ...
            <tr>
              ...
              <td>
              <ul class="nav">
              <!-- <a href="{{route('infaqmasuk.show', $i->id)}}" class="btn btn-warning btn-sm mr-2">Show</a>-->
              <a href="{{route('infaqmasuk.edit', $i->id)}}" class="btn btn-warning btn-sm me-3">Edit</a>
              <form action="{{route('infaqmasuk.destroy', $i->id)}}" method="POST">
            @csrf
            @method('DELETE')
