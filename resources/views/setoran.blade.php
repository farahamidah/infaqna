        ...
        <div class="card-body">
          <table class="table table-bordered">          
            ...
            <tr>
              ...
              {{-- <td><a href="cetak-setoran" target="_blank" class="btn btn-warning">Cetak</a></td> --}}
              <td><a href="{{ route('setoran.show', $i->id) }}" target="_blank" class="btn btn-warning">Cetak</a></td>
